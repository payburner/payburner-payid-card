...
const PayIDCard = class {
    ...
    renderAddress(address) {
        if (address.addressDetails.address) {
            ...
            return h("div", { class: "credit-card selectable", onClick: () => copyTextToClipboard_1(last4) }, h("div", { class: "credit-card-last4" }, last4), typeof address.environment !== 'undefined' ? (h("div", { class: "payid-address-environment" }, address.environment)) : null, h("div", { class: "payid-address-network" }, address.paymentNetwork));
        }
